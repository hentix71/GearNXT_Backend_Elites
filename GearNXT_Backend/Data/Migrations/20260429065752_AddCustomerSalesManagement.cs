    ...
    public partial class AddCustomerSalesManagement : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Front brake pad set", true, "Brake Pad Set", 6800m, 25 },
                    { 2, new DateTime(2026, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Premium oil filter", true, "Oil Filter", 2200m, 40 },
                    { 3, new DateTime(2026, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Engine air filter", true, "Air Filter", 1800m, 35 },
                    { 4, new DateTime(2026, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Heavy-duty clutch plate", true, "Clutch Plate", 9200m, 18 }
                });
