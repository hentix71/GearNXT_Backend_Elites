...
namespace GearNXT_Backend.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        [HttpPatch("staff/{id}/reset-password")]
        public async Task<IActionResult> ResetStaffPassword(int id, [FromBody] AdminResetPasswordDto request)
        {
            try
            {
                await _userService.ResetStaffPasswordAsync(id, request);
